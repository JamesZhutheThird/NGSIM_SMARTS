...
from train_all_in_one_100 import *
...
if __name__ == "__main__":
    ...
    output_dir = './output/20211228-022406-EXP8_fixed_large-t-ft-1000-200-5e-05-0.0001-5e-05/'
    checkpoint_path = output_dir + 'models/final_checkpoint_GAIL_200_finetune.model'
    ...
    if random_flag:
        ...
        env = MATrafficSimNewV(scenarios=["./ngsim"], agent_number=agent_number)
        for epoch in range(100):
            obs = env.reset()
            done = {a_id: False for a_id in obs.keys()}
            n_steps = 300
