...
from prepare_all_in_one_100 import *
...
class PSGAIL():
    def __init__(self,
        ...
        self.discriminator = CriticNet(hidden_size, input_size=state_action_space, output_size=1)
        self.discriminator = self.discriminator.to(device)
        self.value = AgentNet(hidden_size, input_size=state_space, output_size=1)
        self.value = self.value.to(device)
        self.policy = AgentNet(hidden_size, input_size=state_space, output_size=action_space)
